      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 lg:h-20">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <button onClick={() => scrollToSection("gallery")} className="font-inter text-sm lg:text-base text-elegant-black hover:text-elegant-charcoal transition-colors duration-200">
              Galeria
            </button>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-lg border-t">
            <nav className="px-4 py-6 space-y-4">
              ...
              <button onClick={() => scrollToSection("gallery")} className="block w-full text-left font-inter text-elegant-black hover:text-elegant-charcoal transition-colors duration-200 py-2">
                Galeria
              </button>
