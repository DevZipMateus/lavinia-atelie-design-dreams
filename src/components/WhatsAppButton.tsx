export const WhatsAppButton = () => {
  ...
  return <button onClick={handleWhatsAppClick} aria-label="Falar no WhatsApp" className="fixed bottom-6 right-6 z-50 p-3 shadow-lg hover:shadow-xl transition-all duration-500 transform hover:scale-110 group rounded-none">
