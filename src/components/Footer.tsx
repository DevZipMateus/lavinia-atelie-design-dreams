        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-3">
              <a 
                ...
                className="flex items-center justify-center md:justify-start space-x-3 text-gray-300 hover:text-white transition-colors duration-200"
              >
                <Phone className="w-4 h-4" />
                <span className="font-inter">(84) 9 9206-8288</span>
              </a>
              <a 
                href="mailto:laviniareisatelie@gmail.com" 
                className="flex items-center justify-center md:justify-start space-x-3 text-gray-300 hover:text-white transition-colors duration-200"
              >
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              <a 
                href="https://instagram.com/laviniareisatelie" 
                target="_blank" 
                rel="noopener noreferrer"
